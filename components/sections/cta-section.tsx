        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="flex justify-center gap-1">
            {Array.from({ length: 5 }).map((_, index) => (
              <Star key={index} className="size-5 fill-white text-white" />
            ))}
          </div>
          ...
          <p className="mx-auto mt-5 max-w-xl text-white/80">
            Visit TasteHub today and enjoy delicious food, friendly service and
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <a
              ...
              className="flex items-center rounded-full border-white/40 bg-white/10 px-7 text-white hover:bg-white hover:text-orange-500"
            >
